...
list.of.packages <- c("tidyverse","ggrepel","viridis","scales","shiny",
                      ...
                      "shinythemes","DT","RColorBrewer","extrafontdb")
...
# shiny inputs defined here
  ...
  fillRow(
    actionButton("save","Save",width = "50%"),
    actionButton("clean","Clean",width = "50%"))
...
fillCol(flex = c(1,.1),
        ...
        fillRow(
          actionButton("ma1_save","Generate plot!"),
...
fillCol(flex = c(1,.1),
        ...
        fillRow(
          actionButton("ma2_save","Generate plot!"),
