...
output$log2fc = renderPlot({
  ...
  coord_cartesian(
    ...
    geom_label_repel(data = both_data,
                    colour = 'white', fill = gene_colors[1],
                    box.padding = 0.35, point.padding = 0.5,
                    segment.color = 'grey50',
                    aes(label = gene_id),size = 4)+
    geom_label_repel(data = ebv_data,
                    colour = 'white', fill = gene_colors[2],
                    box.padding = 0.35, point.padding = 0.5,
                    segment.color = 'grey50',
                    aes(label = gene_id),size = 4)+
    geom_label_repel(data = noks_data,
                    colour = 'white', fill = gene_colors[3],
                    box.padding = 0.35, point.padding = 0.5,
                    segment.color = 'grey50',
                    aes(label = gene_id),size = 4)
